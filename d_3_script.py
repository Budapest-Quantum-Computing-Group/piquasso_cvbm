...
FILENAME = f"{folder_name}/3_mode_{now.day}_{now.hour}_{now.minute}_{shots}_{seed_sequence}.json"
...
def get_samples(simulator, weights, shots):
    with pq.Program() as program:
        ...
        pq.Q(1, 2) | pq.Beamsplitter(weights[1])
...
if __name__ == "__main__":
    ...
    samples = get_samples(simulator, initial_weights, shots)
